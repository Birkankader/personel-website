...
const translations = {
  en: {
    ...
    'projects.availableSoon': 'Available Soon',
    'projects.underReview': 'Under review on Chrome Web Store',
    'projects.pendingReview': 'Pending Review',
    'projects.viewSource': 'View Project Website',
  ...
  tr: {
    ...
    'projects.availableSoon': 'Yakında Yayında',
    'projects.underReview': 'Chrome Web Store\'da inceleme aşamasında',
    'projects.pendingReview': 'İnceleme Bekliyor',
    'projects.viewSource': 'Proje Websayfasını Gör',
